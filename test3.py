...
from Read_json import deepsort_data
from Read_json import yolo_data
...
def main(config):
    ...
    while not cap.end:
        ...
        # if not deepsort_results:
        #     deepsort_results.append(0)
