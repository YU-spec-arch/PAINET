...
class CustomEnvironment:
    ...
    def v2v_communication(self, my_vehicle_state, surrounding_vehicles_states):
        ...
        for vehicle_id, state in surrounding_vehicles_states.items():
            nearby_vehicle_states[vehicle_id] = my_vehicle_state
        end_time = time.time()
        self.v2v_communication_delay = end_time - start_time
        return nearby_vehicle_states

    def custom_environment_step(self, my_vehicle_id, ver_readnum, action, surrounding_vehicles_states):
